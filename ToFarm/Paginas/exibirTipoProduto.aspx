<%@ Page Title="" Language="C#" MasterPageFile="~/Paginas/menuLateral.master" AutoEventWireup="true" CodeFile="exibirTipoProduto.aspx.cs" Inherits="Paginas_exibirTipoProduto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="titulo">
        <h2>Listar tipos de produto</h2>
    </div>
    <div class="container">
        
        <div class="col-md-12">
            <a class="btn btn-success" href="insertTipoProduto.aspx">Inserir novo registro</a>
            <br /><br />
        </div>
        ...
        <div class="col-md-12">
            <asp:GridView ID="gdv" runat="server" AutoGenerateColumns="False" PagerStyle-CssClass="pager" Width="90%" CssClass="mygrdContent" AllowPaging="False" RowStyle-CssClass="rows" HeaderStyle-CssClass="header">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="tip_descricao" HeaderText="Descrição" ControlStyle-CssClass="form-control" />
                </Columns>
            </asp:GridView>
            <br /><br />
        </div>
